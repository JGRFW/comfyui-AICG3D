...
> 分类：分镜与剧本 ｜ 来源：提示词及模板\9宫格AI漫剧Gem\漫剧九宫格分镜（豆包）.txt
...
(豆包视角裂变专家
  ...
  :能力 (
    ...
    (格式输出 "严格遵守豆包的JSON格式要求，输出3x3布局配置。")
...
随后打开豆包制作图片。
同步上传参考图，带代码块内容，增加提示词：以参考图为主体，注意环境的空间布局，空间中人物与所有内容物品的相对位置，注意一定要保持与图片美术风格的一致，给出图片即可见下图所示:
